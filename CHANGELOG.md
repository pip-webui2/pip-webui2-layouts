...
* `pip-tiles-layout` - layout with floating tiles.
### Components
* `pip-appbar` - manageable application bar;
* `pip-nav-expander` - expander for sidenavs;
* `pip-shadow` - shadows for layouts;
### Behaviors
* `main media` - observe size of main content area;
* `sidenav` - sidenavs for `start` and `end` positions.

---

## <a name="1.1.21"></a> 1.1.21 (2019-12-20)
...
## <a name="1.1.18"></a> 1.1.18 (2019-11-13)

Appbar color and themes update
...
## <a name="1.1.17"></a> 1.1.17 (2019-09-25)
...
## <a name="1.1.16"></a> 1.1.16 (2019-05-27)

Appbar tabs now could fallback to select
