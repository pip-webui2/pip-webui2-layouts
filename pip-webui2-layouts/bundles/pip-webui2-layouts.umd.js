(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('rxjs/operators'), require('@angular/router'), require('rxjs'), require('@angular/core'), require('@angular/common'), require('@angular/flex-layout'), require('@angular/material')) :
    typeof define === 'function' && define.amd ? define('pip-webui2-layouts', ['exports', 'rxjs/operators', '@angular/router', 'rxjs', '@angular/core', '@angular/common', '@angular/flex-layout', '@angular/material'], factory) :
    (factory((global['pip-webui2-layouts'] = {}),global.rxjs.operators,global.ng.router,global.rxjs,global.ng.core,global.ng.common,global.ng['flex-layout'],global.ng.material));
}(this, (function (exports,operators,router,rxjs,core,common,flexLayout,material) { 'use strict';
    ...
    var PipDocumentLayoutComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PipDocumentLayoutComponent.ctorParameters = function () {
            return [
                { type: core.Renderer },
    ...
    ***************************************************************************** */
    ...
    var PipMediaService = /** @class */ (function () {
        function PipMediaService(media) {
            ...
            this.mainChange$ = new rxjs.BehaviorSubject({ aliases: [] });
                ...
                try {
                    for (var _c = __values(this.media['breakpoints'].items), _d = _c.next(); !_d.done; _d = _c.next()) {
                        ...
                        try {
                            ...
                            try {
                                if (matches_1_1 && !matches_1_1.done && (_b = matches_1.return))
                                    _b.call(matches_1);
                            }
                            finally {
                                if (e_4)
        ...
        /** @nocollapse */
        PipMediaService.ctorParameters = function () {
            return [
    ...
    var PipSidenavService = /** @class */ (function () {
        function PipSidenavService(media) {
            this.media = media;
            this._mode$ = new rxjs.BehaviorSubject('side');
            this._opened$ = new rxjs.BehaviorSubject(true);
            this._floatingSidenavAliases = ['xs', 'sm'];
            this._universalSidenavAliases = ['lt-sm', 'sm'];
            this._small = false;
            this._small$ = new rxjs.BehaviorSubject(false);
            this._active$ = new rxjs.BehaviorSubject(true);
            this._isUniversal$ = new rxjs.BehaviorSubject(false);
        }
        ...
        /** @nocollapse */
        PipSidenavService.ctorParameters = function () {
            return [
    ...
    var PipRightnavService = /** @class */ (function () {
        function PipRightnavService(media) {
            ...
            this._fixedRightnavMode$ = new rxjs.BehaviorSubject('side');
        }
         ...
         */
            function (rightnav) {
                if (rightnav === void 0) {
                    rightnav = this._floatingRightnav;
                }
                if (rightnav) ;
                else {
                    console.log('rightnav not found');
        ...
        /** @nocollapse */
        PipRightnavService.ctorParameters = function () {
            return [
                { type: flexLayout.MediaObserver }
            ];
        };
    ...
    var PipMainLayoutComponent = /** @class */ (function () {
        function PipMainLayoutComponent(renderer, elRef, cd, mainMedia, sidenavService, rightnavService, media) {
            ...
            this.media = media;
            this._opened$ = new rxjs.BehaviorSubject(false);
            this.small$ = new rxjs.BehaviorSubject(false);
        ...
        /** @nocollapse */
        PipMainLayoutComponent.ctorParameters = function () {
            return [
                { type: core.Renderer },
                { type: core.ElementRef },
        ...
        PipMainLayoutComponent.propDecorators = {
            pipContainer: [{ type: core.Input }],
            sidenav: [{ type: core.ViewChild, args: ['fixedSidenav',] }],
            rightnav: [{ type: core.ViewChild, args: ['fixedRightnav',] }]
        };
    ...
    var PipMainLayoutAltComponent = /** @class */ (function () {
        function PipMainLayoutAltComponent(renderer2, elRef, cd, mainMedia, sidenavService, rightnavService, media) {
            ...
            this.uFloating$ = new rxjs.BehaviorSubject(false);
            this.small$ = new rxjs.BehaviorSubject(false);
            ...
            this.activeSidenav$ = rxjs.combineLatest(this.sidenavService.opened$, this.sidenavService.active$)
        ...
        /** @nocollapse */
        PipMainLayoutAltComponent.ctorParameters = function () {
            return [
                { type: core.Renderer2 },
                { type: core.ElementRef },
                { type: core.ChangeDetectorRef },
        ...
        PipMainLayoutAltComponent.propDecorators = {
            pipContainer: [{ type: core.Input }],
            sidenav: [{ type: core.ViewChild, args: ['universalSidenav',] }],
            rightnav: [{ type: core.ViewChild, args: ['fixedRightnav',] }]
        };
    ...
    var PipTilesLayoutComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PipTilesLayoutComponent.ctorParameters = function () {
            return [
                { type: core.Renderer },
                { type: core.ElementRef },
                { type: core.ChangeDetectorRef }
    ...
    var PipMenuLayoutComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PipMenuLayoutComponent.ctorParameters = function () {
            return [
                { type: core.Renderer },
                { type: core.ElementRef },
                { type: core.ChangeDetectorRef }
    ...
    var PipShadowComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PipShadowComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
        PipShadowComponent.propDecorators = {
            ...
            attachmentSide: [{ type: core.Input }]
        };
    ...
    var PipCardLayoutComponent = /** @class */ (function () {
        ...
        /** @nocollapse */
        PipCardLayoutComponent.ctorParameters = function () {
            return [
                { type: core.ElementRef }
            ];
        };
    ...
    var PipSidenavExpanderComponent = /** @class */ (function () {
        function PipSidenavExpanderComponent(media, sidenav, cd, renderer, elRef) {
            ...
            this._icon$ = new rxjs.BehaviorSubject('chevron_left');
        }
        ...
        /** @nocollapse */
        PipSidenavExpanderComponent.ctorParameters = function () {
            return [
                { type: PipMediaService },
                { type: PipSidenavService },
                { type: core.ChangeDetectorRef },
    ...
    var PipRootLayoutComponent = /** @class */ (function () {
        function PipRootLayoutComponent(sidenavService, rightnavService, renderer, elRef, media, cd) {
            ...
            this.media = media;
            this.cd = cd;
            this.mode$ = new rxjs.BehaviorSubject(null);
        ...
        /** @nocollapse */
        PipRootLayoutComponent.ctorParameters = function () {
            return [
                { type: PipSidenavService },
                { type: PipRightnavService },
                { type: core.Renderer },
        ...
        PipRootLayoutComponent.propDecorators = {
            sidenav: [{ type: core.ViewChild, args: ['floatingSidenav',] }],
            rightnav: [{ type: core.ViewChild, args: ['floatingRightnav',] }]
        };
    ...
    exports.PipDocumentLayoutComponent = PipDocumentLayoutComponent;
    exports.PipDocumentLayoutModule = PipDocumentLayoutModule;
    exports.PipMainLayoutComponent = PipMainLayoutComponent;
    exports.PipMainLayoutModule = PipMainLayoutModule;
    exports.PipMainLayoutAltComponent = PipMainLayoutAltComponent;
    exports.PipMainLayoutAltModule = PipMainLayoutAltModule;
    exports.PipTilesLayoutComponent = PipTilesLayoutComponent;
    exports.PipTilesLayoutModule = PipTilesLayoutModule;
    exports.PipMenuLayoutComponent = PipMenuLayoutComponent;
    exports.PipMenuLayoutModule = PipMenuLayoutModule;
    exports.PipMediaModule = PipMediaModule;
    exports.PipMediaService = PipMediaService;
    exports.MediaMainChange = MediaMainChange;
    exports.PIP_BREAKPOINTS = PIP_BREAKPOINTS;
    exports.addResizeListener = addResizeListener;
    exports.removeResizeListener = removeResizeListener;
    exports.PipAppbarComponent = PipAppbarComponent;
    exports.PipAppbarModule = PipAppbarModule;
    exports.PipShadowComponent = PipShadowComponent;
    exports.PipShadowModule = PipShadowModule;
    exports.PipSidenavModule = PipSidenavModule;
    exports.PipSidenavService = PipSidenavService;
    exports.PipRightnavModule = PipRightnavModule;
    exports.PipRightnavService = PipRightnavService;
    exports.PipCardLayoutComponent = PipCardLayoutComponent;
    exports.PipCardLayoutModule = PipCardLayoutModule;
    exports.PipScrollableComponent = PipScrollableComponent;
    exports.PipScrollableContentComponent = PipScrollableContentComponent;
    exports.PipScrollableModule = PipScrollableModule;
    exports.PipSidenavExpanderComponent = PipSidenavExpanderComponent;
    exports.PipSidenavExpanderModule = PipSidenavExpanderModule;
    exports.PipRootLayoutComponent = PipRootLayoutComponent;
    exports.PipRootLayoutModule = PipRootLayoutModule;
    exports.ɵa = PipShowHideDirective;

    Object.defineProperty(exports, '__esModule', { value: true });

})));

//# sourceMappingURL=pip-webui2-layouts.umd.js.map